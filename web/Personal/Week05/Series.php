...
try {
    ...
    // get all series
    $series = $bookDB->get_series_all($pdo);
}
        ...
        <table id="series" class="display" cellspacing="0" width="100%">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <?php echo htmlspecialchars($s['text']); ?>
                    </td>
                    <td>
                        <button type="button" class="btn btn-small btn-primary button btn-rick" value="<?=$series_id?>" data-toggle="modal" data-target="#modelEdit" data-backdrop="static" data-keyboard="false">Edit</button>
                    </td>
                </tr>
                <?php endforeach; ?>
                <?php endif; ?>
